...
void j1App::SaveGameFake() const
{
	want_to_save = true;
}

void j1App::LoadGameFake()
{
	want_to_load = true;
}

void j1App::SaveGameTrue() const
{
	pugi::xml_document save_file;
	pugi::xml_parse_result result = save_file.load_file("savegame.xml");
	pugi::xml_node cam = save_file.child("save").child("renderer").append_child("camera");
...
void j1App::LoadGameTrue()
{
	pugi::xml_document save_file;
	pugi::xml_parse_result result = save_file.load_file("savegame.xml");
	pugi::xml_node cam = save_file.child("save").child("renderer").child("camera");

	App->render->camera.x = cam.attribute("x").as_int();
	App->render->camera.y = cam.attribute("y").as_int();
